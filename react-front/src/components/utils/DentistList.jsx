...
const Search = ({ dentists, handleSearch }) => {
    const handleonChangeSearch = (e) => {
        handleSearch(e.target.value, 'dentists')
    }
        ...
        <>
            <div className="mx-3 my-3">
                ...
                <div className="relative">
                    ...
                    <button
                        // onClick={() => handleSearch(searchQuery, 'dentists')}
                        type="submit"
            ...
            <div className="mt-3">
                <div className="flex justify-end mt-3">
                    <Link to="new" className="flex bg-blue-700 rounded-lg hover:bg-blue-800 text-white font-bold py-2 px-2 shadow-2xl">
                        <div className="flex">
                            <div className="me-1">
            ...
            <div className="mt-3">
                {dentists.searchResult.length ?
                    <DentistList
                        dentists={dentists.searchResult} /> : (
                        <p className="mt-2 text-center text-red-600 dark:text-red-500">
                            <span className="font-medium">Sorry i can't find any dentist </span>
                        </p>
                    )
                }
            </div>
