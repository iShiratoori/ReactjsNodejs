...
const Card = ({ dentist, name, dob, img, id }) => {
        ...
        <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <div className="flex justify-end px-4 pt-4">
                ...
                <div ref={dropdownRef} className={dropdownClass}>
                    <ul className="py-2 mx-3" aria-labelledby="dropdownButton">
                        <li>
                            <button
                                onClick={() => handleModelOpening('edit', 'dentist')}
                                className="w-full py-2 rounded-md text-gray-700 hover:bg-[#0C5FCD] hover:text-white   dark:text-gray-200"
                            >Edit</button>
                        </li>
                        <li>
                            <button
                                onClick={() => handleModelOpening('delete', 'dentist')}
                                className="w-full py-2 rounded-md text-red-500 hover:bg-red-600 hover:text-white"
                            >Delete</button>
                        </li>
                    </ul>
                </div>
            ...
            <div className="flex flex-col items-center pb-10">
                <img className="w-24 h-24 mb-3 rounded-full shadow-lg" src={img} alt={`Dentist ${name}`} />
