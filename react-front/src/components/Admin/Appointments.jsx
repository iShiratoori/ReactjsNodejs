...
const AppointmentList = ({ appointment, id, deleteAppointment }) => {
            ...
            <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
                <div className="flex justify-end items-center">
                    <div className="bg-white dark:bg-gray-700  px-3">
                        <button onClick={() => alert('HI')} type="button">
                ...
                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        {appointments.map((appointment) => (
                            <AppointmentList key={appointment._id} appointment={appointment} id={appointment._id} deleteAppointment={deleteAppointment} />
                        ))}
                    </tbody>
                </table>
            </div>
